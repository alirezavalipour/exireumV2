                                    ...
                                    <div className="col-12">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9 col-12 bg-light mx-auto rounded shadow-lg box-triangle1 mt-3 small">
                                                <div className="col-12 mt-2 text-center">To exchange XLM with XIR,</div>
                                                <div className="col-12 mt-2 mb-2 text-center">enter the amount of XLM you are going to change.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-12 border-bottom border-warning">
                                        <div className="row mt-2 mb-2">
                                            ...
                                            <div className="col-sm-11 pl-0 d-none d-sm-block small font-weight-bold">Exchange XLM with XIR</div>
                                            <div className="col-12 d-sm-none d-bolck small font-weight-bold">Exchange XLM with XIR</div>
                                        </div>
                                    </div>
                                    <form className="col-12" onSubmit={this.handleFormSubmit}>
                                        ...
                                        <label className="col-12 mt-2">
                                            <div className="row">
                                                <span className="col-sm-3 col-12 pt-1 pb-1 small font-weight-bold">Amount will be XIR :</span>
                                                <div className="col-sm-9 col-12 text-center rounded pt-1 pb-1 border-div2">  {exir}  </div>
                                            </div>
                                        </label>
                                        {loader}
                                    </form>
                                    ...
                                    <div className="col-12">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-9 col-12 bg-light mx-auto rounded shadow-lg box-triangle2 mt-3 small">
                                                <div className="col-12 mt-2 text-center">You are changing <span className="font-weight-bold">{this.state.amount}</span> XIR with {exir} XLM</div>
                            ...
                            <div className="col-sm-8 col-12 clearfix mx-auto border border-warning shadow-lg mt-3 mb-3">
                                <div className="row">
                                    <div className="col-12 border-bottom border-warning">
                                        <div className="row mt-2 mb-2">
                                            <div className="col-sm-1 d-none d-sm-block icon6"> </div>
                                            <div className="col-sm-11 d-none d-sm-block pl-0 small font-weight-bold">Exchange XLM with XIR</div>
                                            <div className="col-12 d-sm-none d-block small font-weight-bold">Exchange XLM with XIR</div>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-12 border-bottom border-warning">
                                        <div className="row mt-2 mb-2">
                                            ...
                                            <div className="col-sm-11 d-sm-block d-none pl-0 small font-weight-bold">Exchange XLM with XIR</div>
                                            <div className="col-12 d-sm-none d-block small font-weight-bold">Exchange XLM with XIR</div>
                                        </div>
                                    </div>
